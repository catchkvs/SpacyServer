...
TRAIN_DATA = [
    ...
    (
        "Hundreds of thousands of AWS customers have chosen DynamoDB as their key-value and document database", 
         {"entities": [(52, 60, LABEL)]}
    ),
    (
...
def main(model=None, new_model_name="awsservice", output_dir="/home/interviewparrot/ws/SpacyServer/models", n_iter=30):
    ...
    test_text = "I have a table in DynamoDB and I am trying to display the data from it using react"
    doc = nlp(test_text)
